...
struct MapThumbnailWithDelete: View {
    ...
    @State private var region = MKCoordinateRegion(center: CLLocationCoordinate2D(latitude: 51.5, longitude: -0.12),
...
struct MapThumbnailWithDelete_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            MapThumbnailWithDelete(location: [-0.106, 51.506], action: {})
            MapThumbnailWithDelete(location: [-0.106, 51.506])
        }
